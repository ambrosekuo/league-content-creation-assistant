...
gcloud run jobs deploy vod-portrait-process \
  ...
  --command=python \
  --args="cloud_job.py,process-portraits,--vod-id,${VOD_ID},--cleanup,--clean-work,--force,--preset,veryfast,--crf,20,--track-champion,--game-zoom,0.65,--cam-hole,fill,--intro,none,--no-outro,--music,off"
